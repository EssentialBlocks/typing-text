...
jQuery(document).ready(function ($) {
  $(".eb-typed-wrapper").each(function () {
    var typeSpeed = $(this).find('.eb-typed-content').data("type-speed"),
        ...
        showCursor = $(this).find('.eb-typed-content').data("cursor"); // Generate array of strings for TypedJs

    var strings = [];
    $(this).find(".eb-typed-text").each(function () {
      strings.push(this.innerHTML);
    });
    $(this).find(".eb-typed-view").each(function () {
      new Typed(this, {
        strings: strings,
        typeSpeed: typeSpeed,
